...
En este módulo aprenderás como es el proceso mediante el cual se generan las esgructuras que forman parte de las bases de datos. Un dato es "una representación simbólica de un objeto o hecho de la realidad".
...
El modelo entidad-relación, nos permite representar estos objetos de forma visual y ordenada, en el las entidades se representan con rectángulos, los atributos como elipses y las relaciones con líneas y rombos que grafi el tipo de relación.
...
MySQL: [Download](https://dev.mysql.com/downloads/installer/)<br>
